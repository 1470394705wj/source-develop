...
def fixture_session():
    ...
    log_utils = LogUtils(name='vde_received_test',
                         info_file=os.path.join(LOG_DIR, 'data_test/vde_received/info.log'),
                         error_file=os.path.join(LOG_DIR, 'data_test/vde_received/error.log'),
                         alarm_file=os.path.join(LOG_DIR, 'data_test/vde_received/alarm.log'))
